...
MEM_0 := NIOSDuino_Core_onchip_flash_0
...
$(MEM_0)_END := 0x010cdfff
$(MEM_0)_SPAN := 0x0004e000
...
$(HDL_SIM_DIR)/$(MEM_0).dat: $(MEM_0).flash
	...
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0x4dfff --width=$(mem_width) \
...
MEM_1 := NIOS_test_board_onchip_ram
...
$(MEM_1)_START := 0x01108000
$(MEM_1)_END := 0x0110ffff
