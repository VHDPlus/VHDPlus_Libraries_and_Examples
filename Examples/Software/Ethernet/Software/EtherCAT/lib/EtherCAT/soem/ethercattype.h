...
#define EC_MAXBUF          2 // TODO shrinked for memory reduction (original = 16)
/** timeout value in us for tx frame to return to rx */
#define EC_TIMEOUTRET      20000 // TODO For some reason, it takes too much time to receive data (oiginal = 2000)
